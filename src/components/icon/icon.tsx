...
import neovimSvg from './assert/neovim.svg'
...
export function GithubIcon(props: JSX.IntrinsicElements['svg'], key: string) {
  return (
    <svg
...
export function ReactIcon(props: JSX.IntrinsicElements['img']) {
  return <img {...props} src={reactSvg} />
}

export function TypescriptIcon(props: JSX.IntrinsicElements['img']) {
  return <img src={typescriptSvg} {...props} />
}

export function ThreejsIcon(props: JSX.IntrinsicElements['img']) {
  return <img src={threejsSvg} {...props} />
}
